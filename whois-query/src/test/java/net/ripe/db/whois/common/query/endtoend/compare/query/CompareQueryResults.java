package net.ripe.db.whois.common.query.endtoend.compare.query;
...
import net.ripe.db.whois.common.query.endtoend.compare.CompareResults;
...
import static net.ripe.db.whois.common.query.endtoend.compare.ComparisonPrinter.writeDifferences;
