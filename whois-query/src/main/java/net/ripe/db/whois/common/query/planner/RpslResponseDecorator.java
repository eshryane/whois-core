...
import net.ripe.db.whois.common.query.executor.decorators.DummifyDecorator;
import net.ripe.db.whois.common.query.executor.decorators.FilterPersonalDecorator;
import net.ripe.db.whois.common.query.executor.decorators.FilterPlaceholdersDecorator;
import net.ripe.db.whois.common.query.executor.decorators.FilterTagsDecorator;
...
public class RpslResponseDecorator {
    ...
    private Iterable<? extends ResponseObject> filterAuth(Query query, final Iterable<? extends ResponseObject> objects) {
        ...
        final FilterAuthFunction filterAuthFunction =
                CollectionUtils.isEmpty(passwords) ?
                        FILTER_AUTH_FUNCTION :
                        new FilterAuthFunction(passwords, rpslObjectDao);
