...
public class SelfReferencePreventionValidator implements BusinessRuleValidator {
    ...
    public void validate(final PreparedUpdate update, final UpdateContext updateContext) {
        errorOnSelfReference(update, updateContext, AttributeTypes.ADMIN_C);
        errorOnSelfReference(update, updateContext, AttributeTypes.TECH_C);
    }
    ...
    private void errorOnSelfReference(final PreparedUpdate update, final UpdateContext updateContext, final AttributeType attributeType) {
        ...
        final CIString submittedNicHdl = update.getUpdate().getSubmittedObject().getValueForAttribute(AttributeTypes.NIC_HDL);
