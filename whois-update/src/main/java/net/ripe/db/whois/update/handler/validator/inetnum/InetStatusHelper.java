...
final class InetStatusHelper {
    ...
    public static InetStatus getStatus(final PreparedUpdate update) {
        return getStatus(update.getUpdatedObject().getValueForAttribute(AttributeTypes.STATUS), update);
    }

    public static InetStatus getStatus(final RpslObject update) {
        return getStatus(update.getValueForAttribute(AttributeTypes.STATUS), update);
    }
