...
public class UpdateMessagesTest {
    ...
    public void authentication_failed_empty_list() {
        ...
        final Message result = UpdateMessages.authenticationFailed(object, AttributeTypes.MNT_BY, Lists.<RpslObject>newArrayList());
    ...
    public void authentication_failed_with_list() {
        ...
        final Message result = UpdateMessages.authenticationFailed(object, AttributeTypes.MNT_BY, Lists.newArrayList(mntner));
