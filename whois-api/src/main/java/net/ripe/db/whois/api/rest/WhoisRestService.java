...
import net.ripe.db.whois.common.query.domain.VersionWithRpslResponseObject;
...
import static net.ripe.db.whois.common.query.QueryFlag.CLIENT;
import static net.ripe.db.whois.common.query.QueryFlag.DIFF_VERSIONS;
import static net.ripe.db.whois.common.query.QueryFlag.FILTER_TAG_EXCLUDE;
import static net.ripe.db.whois.common.query.QueryFlag.FILTER_TAG_INCLUDE;
import static net.ripe.db.whois.common.query.QueryFlag.LIST_SOURCES;
import static net.ripe.db.whois.common.query.QueryFlag.LIST_SOURCES_OR_VERSION;
import static net.ripe.db.whois.common.query.QueryFlag.LIST_VERSIONS;
import static net.ripe.db.whois.common.query.QueryFlag.NO_GROUPING;
import static net.ripe.db.whois.common.query.QueryFlag.NO_TAG_INFO;
import static net.ripe.db.whois.common.query.QueryFlag.PERSISTENT_CONNECTION;
import static net.ripe.db.whois.common.query.QueryFlag.PRIMARY_KEYS;
import static net.ripe.db.whois.common.query.QueryFlag.SELECT_TYPES;
import static net.ripe.db.whois.common.query.QueryFlag.SHOW_TAG_INFO;
import static net.ripe.db.whois.common.query.QueryFlag.SHOW_VERSION;
import static net.ripe.db.whois.common.query.QueryFlag.SOURCES;
import static net.ripe.db.whois.common.query.QueryFlag.TEMPLATE;
import static net.ripe.db.whois.common.query.QueryFlag.VERBOSE;
import static net.ripe.db.whois.common.query.QueryFlag.VERSION;
...
public class WhoisRestService {
    ...
    public Response delete(
        ...
        final UpdateContext updateContext = updatePerformer.initContext(origin);
